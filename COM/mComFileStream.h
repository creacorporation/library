...
#ifndef MCOMFILESTREAM_H_INCLUDED
#define MCOMFILESTREAM_H_INCLUDED
...
public:
	...
	mComFileStream( DWORD buffersize = 4096 );
	virtual ~mComFileStream();
...
private:
	...
	mComFileStream( const mComFileStream& source ) = delete;
	void operator=( const mComFileStream& source ) = delete;
